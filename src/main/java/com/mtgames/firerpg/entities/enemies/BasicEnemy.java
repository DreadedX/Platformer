...
public class BasicEnemy extends Mob {
	...
	public void render(Screen screen) {
		...
		screen.render(xOffset + 8 - modifier, yOffset,
				(xTile + 1) + yTile * 32, dir);
		screen.render(xOffset + modifier, yOffset + 8,
				xTile + (yTile + 1) * 32, dir);
		screen.render(xOffset + 8 - modifier, yOffset + 8, (xTile + 1)
				+ (yTile + 1) * 32, dir);
	}
}
