...
public class LevelLoader {
	...
	public LevelLoader(Level level, InputHandler input, String path)
			throws Exception {
		...
		NodeList tileList = document.getDocumentElement().getElementsByTagName(
				"tile");
		NodeList entityList = document.getDocumentElement()
